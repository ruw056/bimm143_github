...
- [Combing methods](#combing-methods)
...
Check the mean and standard deviation of the features of the `wisc.data`
to determine if the data should be scaled

`scale=TRUE` is very important since the data are on very different
scales in the OG data set.
...
![](Class-8-Lab_files/figure-commonmark/unnamed-chunk-11-1.png)
...
![](Class-8-Lab_files/figure-commonmark/unnamed-chunk-12-1.png)
...
![](Class-8-Lab_files/figure-commonmark/unnamed-chunk-13-1.png)
...
![](Class-8-Lab_files/figure-commonmark/unnamed-chunk-15-1.png)
...
![](Class-8-Lab_files/figure-commonmark/unnamed-chunk-16-1.png)
...
original data to see if there is any grouping into malignant and benign
clusters.
...
![](Class-8-Lab_files/figure-commonmark/unnamed-chunk-20-1.png)
...
```
    ...
    [1] 8.899608 4.625605 8.828179 7.003860 7.321522 8.367674
...
![](Class-8-Lab_files/figure-commonmark/unnamed-chunk-21-1.png)
...
![](Class-8-Lab_files/figure-commonmark/unnamed-chunk-23-1.png)

> Q12. Which method gives your favorite results for the same data.dist
> dataset? Explain your reasoning.

It would also be `ward.D2` because it gave much better visual than other
methods.
...
![](Class-8-Lab_files/figure-commonmark/unnamed-chunk-26-1.png)
...
![](Class-8-Lab_files/figure-commonmark/unnamed-chunk-30-1.png)

> Q16. Which of these new patients should we prioritize for follow up
> based on your results?

We should prioritize patient 1 first because they are at a higher risk
since they look more similar to the malignant cases
